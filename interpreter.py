...
class Interpreter:
    def __init__(self, config, filename=None, repl=False):
        self.variables = {
            ...
            "list": b_classes.Function(is_builtin=True, function=b_functions.list, name="list"),
            "map": b_classes.Function(is_builtin=True, function=b_functions.map, name="map"),
            "abs": b_classes.Function(is_builtin=True, function=b_functions.abs, name="abs"),
