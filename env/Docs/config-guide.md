...
### 9\. `allow_fetch`
*   **Type:** `bool`
* **Description:** If `true`, the `fetch` function is allowed. This function is used to fetch data from external sources, such as APIs or databases.

### 10\. `execute_code_blocks`
*   **Type:** `object`
