import difflib
import os
from env.Lib.Builtins.old import functions as b_functions
from env.Lib.Builtins.old import classes as b_classes
from env.Lib.Builtins.old import exceptions as b_exceptions
from env.Lib.Builtins.old import variables as b_variables
...
# CODE WILL BE DEPRECATED
# ITS SLOW I DON'T RECOMMEND USING IT IN PROD
...
class Interpreter:
    ...
    def evaluate(self, statement):
        if statement["type"] == "FUNCTIONDECLARATION":
            ...
            if type != get_type(statement["value"]):
                raise TypeError(
                    f"Expected type '{statement['variable_type']}', but got '{get_type(statement['value'])}'")
